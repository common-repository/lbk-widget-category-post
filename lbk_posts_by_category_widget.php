...
if ( !class_exists('LBKCategoryPosts') ) {
	...
	?>
			...
			<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title_lines'));?>" name="<?php echo esc_attr($this->get_field_name('title_lines'));?>" type="number" value="<?php echo esc_attr($title_lines);?>" /></label></p>
